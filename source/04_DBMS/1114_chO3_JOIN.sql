...
SELECT E.EMPNO, ENAME, JOB, SAL, d.dname
FROM EMP E, DEPT D
WHERE e.deptno = d.deptno 
  AND SAL>=2500
  AND JOB='MANAGER'
...
SELECT E.EMPNO, ENAME, JOB, SAL, S.GRADE
...
SELECT W.ENAME, W.MGR, M.EMPNO, M.ENAME
  FROM EMP W, EMP M
  WHERE W.MGR = M.EMPNO(+);
  --EX1. 'SMITH의 상사는 FORD다' - 'KING'DML 상사는 없다'
